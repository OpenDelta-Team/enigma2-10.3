...
DEFAULT_SKIN = SystemInfo["HasFullHDSkinSupport"] and "AreaDeltasSat_FHD_Pro/skin.xml" or "AREADELTASAT-FHD/skin.xml"  # SD hardware is no longer supported by the default skin.
